...
export default function Licao3({ onVoltar }: LicaoProps) {
        ...
        if (docSnap.exists()) {
          ...
          if (data.respostasQuestionarios && data.respostasQuestionarios['jesus']) {
            ...
            setRespostas({
              ...
              q2: salvas['2) Onde Jesus nasceu e em qual cidade ele cresceu e se desenvolveu?'] || '',
              q3: salvas['3) De acordo com Lucas 19:10, qual era a missão principal de Jesus na terra?'] || '',
              q4: salvas['4) O que aconteceu no terceiro dia após a morte de Jesus, e por quantas pessoas estimadas ele foi visto?'] || '',
              q5: salvas['5) O que é necessário fazer para conhecer mais sobre Jesus e obter o perdão dos nossos pecados?'] || ''
            });
          }
        }
      } catch (error) {
  ...
  const handleSalvarRespostas = async () => {
    ...
    const payloadRespostas = {
      ...
      '2) Onde Jesus nasceu e em qual cidade ele cresceu e se desenvolveu?': respostas.q2,
      '3) De acordo com Lucas 19:10, qual era a missão principal de Jesus na terra?': respostas.q3,
      '4) O que aconteceu no terceiro dia após a morte de Jesus, e por quantas pessoas estimadas ele foi visto?': respostas.q4,
      '5) O que é necessário fazer para conhecer mais sobre Jesus e obter o perdão dos nossos pecados?': respostas.q5,
    };
    ...
    <div className="licao-page">
      ...
      <article className="licao-container">
        ...
        <section className="licao-section">
          ...
          <p>
            Nasceu em Belém de Judá (Miqueias 5:2; Mateus 2:1), de uma virgem chamada Maria, 
            que estava desposada com José (Mateus 1:18). Seus pais eram pessoas humildes e 
            habitavam em Nazaré, cidade da Galileia (Mateus 21:11). Ali Ele cresceu e se desenvolveu; 
            quando atingiu a maioridade, saiu pelas regiões de Judá para anunciar o Evangelho (boas-novas) 
            do Reino de Deus (Mateus 4:13-17). Sua missão era <strong>"buscar e salvar o que se havia 
            perdido"</strong> (Lucas 19:10). No entanto, os judeus (Seus patrícios) não O receberam como seu 
            “Salvador” (João 1:11). Desse modo, a promessa da salvação se estendeu a todos os povos (João 1:12).
          </p>
        </section>
        ...
        <section className="licao-section">
          ...
          <p>
            ...
            Jesus desfez-se de Sua glória, veio a este mundo e morreu na cruz em prol da salvação da 
        ...
        <section className="licao-section">
          ...
          <p>
            ...
            mais de quinhentas pessoas, dentre as quais algumas ainda estavam vivas nos dias do 
            apóstolo Paulo (1 Coríntios 15:6).
          </p>
          <p>
            Após Sua ressurreição, antes de ser assunto ao céu, disse aos Seus discípulos que 
            deveriam dar continuidade à Sua missão (Mateus 28:19-20; Marcos 16:15-20). 
        ...
        <section className="licao-section questionario-section">
          ...
          <div className="form-group">
            <label>2) Onde Jesus nasceu e em qual cidade ele cresceu e se desenvolveu?</label>
            <input 
              type="text" 
              placeholder="..." 
              value={respostas.q2} 
          ...
          <div className="form-group">
            <label>4) O que aconteceu no terceiro dia após a morte de Jesus, e por quantas pessoas estimadas ele foi visto?</label>
            <input 
              type="text" 
              placeholder="..." 
              value={respostas.q4} 
          ...
          <div className="form-group">
            <label>5) O que é necessário fazer para conhecer mais sobre Jesus e obter o perdão dos nossos pecados?</label>
            <input 
              type="text" 
              placeholder="..." 
              value={respostas.q5} 
