    ...
    const carregarRespostas = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data.respostasQuestionarios && data.respostasQuestionarios['discipulo-gerando-discipulo']) {
    ...
    try {
      ...
      await setDoc(docRef, {
        respostasQuestionarios: {
          'discipulo-gerando-discipulo': payloadRespostas
        }
      }, { merge: true });
